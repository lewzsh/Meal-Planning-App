//have Note arraylist, the constructor, setters, getters
...
//    if the note user that chose is found, return it
...
//    when populate the list, show only the nonDeleted notes
