...
// we don't use that
        ...
        SQLiteDatabase sqLiteDatabase = this.getWritableDatabase();
            ...
            contentValues.put(DELETE_FIELD, getStringFromDate(note.getDeleted()));

            sqLiteDatabase.insert(TABLE_NAME, null, contentValues);

        }

//        repopulate note memory
...
//    this will update the edited note into the db - similar to add note
